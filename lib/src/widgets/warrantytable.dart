...
class _WarrantyTableState extends State<WarrantyTable> {
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      ...
      return SizedBox(
        height: 400, // ✅ altura acotada para scroll vertical
        child: Scrollbar(
            ...
            child: Scrollbar(
              ...
              child: SingleChildScrollView(
                ...
                child: DataTable(
                  ...
                  rows: controller.listaGarantias.map((Warranty g) {
                    return DataRow(
                      cells: [
                        DataCell(Text(g.dni)),
                        ...
                        DataCell(
                          Text(
                            g.fechaEntrada.toLocal().toString().split(" ")[0],
                          ),
                        ),
                        DataCell(
                          Text(
                            g.fechaVencimiento.toLocal().toString().split(
                              " ",
                            )[0],
                          ),
                        ),
